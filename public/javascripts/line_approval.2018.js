...
app.controller('ddController', ['$scope', '$uibModal', '$log', '$timeout', '$http', '$cookies','$translate',  function ($scope, $uibModal, $log, $timeout, $http, $cookies, $translate) {
        ...
        swal({
            ...
            if (result.value) {
                ...
                $http.put("/api/runs/line/" + runId, run).then(function (response) {
                    ...
                    swal("Oops", "It could not be sent normally. Please call the system manager.(Public)", "error");
                    console.log("Error: " + response.statusText);
                });
