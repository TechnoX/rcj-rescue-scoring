  ...
  function updateRunList() {
    $http.get("/api/competitions/" + competitionId + "/runs?populate=true").then(function (response) {
      ...
      for (var i in primaryTeamRuns) {
        ...
        $scope.primaryRunsTop .push({team : {name : run.team.name}, score : teamRun.sumScore, time : teamRun.sumTime})
      }
      ...
      for (var i in secondaryTeamRuns) {
        ...
        $scope.secondaryRunsTop .push({team : {name : run.team.name}, score : teamRun.sumScore, time : teamRun.sumTime})
      }
