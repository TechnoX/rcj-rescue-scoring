...
angular.module("RunAdmin", []).controller("RunAdminController", function ($scope, $http) {
    ...
    get_round = function () {
        $http.get("/api/competitions/" + competitionId +
            "/rounds/Line/" + obj[$scope.now][0]).then(function (response) {
    ...
    get_team = function () {
        $http.get("/api/competitions/" + competitionId +
            "/teams/Line/" + obj[$scope.now][1]).then(function (response) {
    ...
    get_field = function () {
        $http.get("/api/competitions/" + competitionId +
            "/fields/Line/" + obj[$scope.now][3]).then(function (response) {
    ...
    get_map = function () {
        $http.get("/api/maps/line/name/" + obj[$scope.now][2]).then(function (response) {
